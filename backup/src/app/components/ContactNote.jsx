...
export default function ContactNote({ initialPosition, color = 'blue', title = 'Leave a Note', content = '', number = '06', rotate = 'rotate(-1deg)', zoom = 100 }) {
      ...
      >
        ...
        <div className="note__inner">
          <div className="note__content-wrapper">
            <p className="note__number">{number}</p>
